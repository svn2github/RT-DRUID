...
//			"    CPU_ID = \"default_cpu\";\n" +
	...
	@Test
	public void testPortingMulti6_far_small_ca78k0r() {
	    final String text = "CPU mySystem {\n" +
				"\n" +
				"	OS myOs {\n" +
				"\n" +
	...
	@Test
	public void testPortingMulti6_near_medium_ca78k0r() {
	    final String text = "CPU mySystem {\n" +
				"\n" +
				"	OS myOs {\n" +
				"\n" +
	...
	@Test
	public void testPortingMulti6_ca78k0r_fp() {
	    final String text = "CPU mySystem {\n" +
				"\n" +
				"	OS myOs {\n" +
				"\n" +
	...
	@Test
	public void testPortingMulti6_ca78k0r_bcc1() {
	    final String text = "CPU mySystem {\n" +
				"\n" +
				"	OS myOs {\n" +
				"\n" +
