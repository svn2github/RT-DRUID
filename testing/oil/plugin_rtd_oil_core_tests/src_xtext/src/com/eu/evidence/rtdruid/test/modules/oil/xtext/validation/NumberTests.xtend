...
//		assertConstraints(issues.errorsOnly.inLine(10).under(typeof(ValueType)).oneOfThemContains("INT32"))
		...
		assertConstraints(issues.errorsOnly.inLine(21).under(typeof(ValueType)).oneOfThemContains("positive"))
		assertConstraints(issues.errorsOnly.inLine(22).under(typeof(ValueType)).oneOfThemContains("UINT32"))
		assertConstraints(issues.errorsOnly.inLine(23).under(typeof(ValueType)).oneOfThemContains("UINT32"))
		assertConstraints(issues.errorsOnly.inLine(25).under(typeof(ValueType)).oneOfThemContains("UINT32"))
		assertConstraints(issues.errorsOnly.inLine(26).under(typeof(ValueType)).oneOfThemContains("UINT32"))
		assertConstraints(issues.errorsOnly.inLine(28).under(typeof(ValueType)).oneOfThemContains("AUTO"))
		assertConstraints(issues.errorsOnly.inLine(30).under(typeof(ValueType)).oneOfThemContains("UINT32"))
		...
		assertConstraints(issues.errorsOnly.inLine(37).under(typeof(ValueType)).oneOfThemContains("INT64"))
		assertConstraints(issues.errorsOnly.inLine(38).under(typeof(ValueType)).oneOfThemContains("INT64"))
//		assertConstraints(issues.errorsOnly.inLine(40).under(typeof(ValueType)).oneOfThemContains("INT64"))
		assertConstraints(issues.errorsOnly.inLine(43).under(typeof(ValueType)).oneOfThemContains("AUTO"))
		assertConstraints(issues.errorsOnly.inLine(45).under(typeof(ValueType)).oneOfThemContains("INT64"))
		...
		assertConstraints(issues.errorsOnly.inLine(51).under(typeof(ValueType)).oneOfThemContains("positive"))
		assertConstraints(issues.errorsOnly.inLine(52).under(typeof(ValueType)).oneOfThemContains("UINT64"))
		assertConstraints(issues.errorsOnly.inLine(53).under(typeof(ValueType)).oneOfThemContains("UINT64"))
		assertConstraints(issues.errorsOnly.inLine(55).under(typeof(ValueType)).oneOfThemContains("UINT64"))
		assertConstraints(issues.errorsOnly.inLine(58).under(typeof(ValueType)).oneOfThemContains("AUTO"))
		assertConstraints(issues.errorsOnly.inLine(60).under(typeof(ValueType)).oneOfThemContains("UINT64"))
		assertConstraints(issues.errorsOnly.inLine(61).under(typeof(ValueType)).oneOfThemContains("UINT64"))
		assertConstraints(issues.errorsOnly.inLine(62).under(typeof(ValueType)).oneOfThemContains("UINT64"))
		
		assertConstraints(issues.errorsOnly.inLine(69).under(typeof(ValueType)).oneOfThemContains("FLOAT"))
		assertConstraints(issues.errorsOnly.inLine(70).under(typeof(ValueType)).oneOfThemContains("FLOAT"))
		...
		assertConstraints(issues.errorsOnly.inLine(73).under(typeof(ValueType)).oneOfThemContains("AUTO"))
		assertConstraints(issues.errorsOnly.inLine(75).under(typeof(ValueType)).oneOfThemContains("FLOAT"))
		assertConstraints(issues.errorsOnly.inLine(76).under(typeof(ValueType)).oneOfThemContains("FLOAT"))
		assertConstraints(issues.errorsOnly.inLine(77).under(typeof(ValueType)).oneOfThemContains("FLOAT"))
		
		assertConstraints(issues.errorsOnly.inLine(84).under(typeof(ValueType)).oneOfThemContains("DOUBLE"))
		assertConstraints(issues.errorsOnly.inLine(85).under(typeof(ValueType)).oneOfThemContains("DOUBLE"))
		...
		assertConstraints(issues.errorsOnly.inLine(88).under(typeof(ValueType)).oneOfThemContains("AUTO"))
		assertConstraints(issues.errorsOnly.inLine(90).under(typeof(ValueType)).oneOfThemContains("DOUBLE"))
		assertConstraints(issues.errorsOnly.inLine(91).under(typeof(ValueType)).oneOfThemContains("DOUBLE"))
