...
/**
 * This is the item provider adapter for a {@link com.eu.evidence.rtdruid.vartree.data.Annotation} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class AnnotationItemProvider
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(DataPackage.Literals.ANNOTATION__EXEC_TIME_LISTS);
			childrenFeatures.add(DataPackage.Literals.ANNOTATION__CACHE_MISS_COST_LISTS);
		}
	...
	public String getText(Object object) {
		PropertyVar labelValue = ((Annotation)object).getProperties();
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(DataPackage.Literals.ANNOTATION__EXEC_TIME_LISTS,
				 DataFactory.eINSTANCE.createExecTimeList()));

		newChildDescriptors.add
			(createChildParameter
				(DataPackage.Literals.ANNOTATION__CACHE_MISS_COST_LISTS,
				 DataFactory.eINSTANCE.createCacheMissCostList()));
	}
