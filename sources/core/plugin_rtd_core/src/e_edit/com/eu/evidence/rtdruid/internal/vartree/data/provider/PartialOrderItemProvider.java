 ...
 * </copyright>
 *
 * $Id: PartialOrderItemProvider.java,v 1.1 2005/09/28 15:22:29 durin Exp $
 */
...
/**
 * This is the item provider adpater for a {@link rtdruid.vartree.data.PartialOrder} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class PartialOrderItemProvider
		...
		itemPropertyDescriptors.add
			(new ItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_PartialOrder_ModeRef_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_PartialOrder_ModeRef_feature", "_UI_PartialOrder_type"),
				 DataPackage.eINSTANCE.getPartialOrder_ModeRef(),
				 true,
	...
	public Collection getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(DataPackage.eINSTANCE.getPartialOrder_OrderList());
		}
	...
	public Object getImage(Object object) {
		return getResourceLocator().getImage("full/obj16/PartialOrder");
	}
	...
	public String getText(Object object) {
		String modeValue = varToString(((PartialOrder)object).getModeRef());
		
		return getString("_UI_PartialOrder_type") 
	...
	protected void collectNewChildDescriptors(Collection newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(DataPackage.eINSTANCE.getPartialOrder_OrderList(),
				 DataFactory.eINSTANCE.createOrder()));
	}
