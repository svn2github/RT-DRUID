...
/**
 * This is the item provider adapter for a {@link com.eu.evidence.rtdruid.vartree.data.Mapping} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class MappingItemProvider
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(DataPackage.Literals.MAPPING__PROC_MAP_LIST);
			childrenFeatures.add(DataPackage.Literals.MAPPING__TASK_MAP_LIST);
			childrenFeatures.add(DataPackage.Literals.MAPPING__VAR_MAP_LIST);
		}
	...
	public String getText(Object object) {
		PropertyVar labelValue = ((Mapping)object).getProperties();
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(DataPackage.Literals.MAPPING__PROC_MAP_LIST,
				 DataFactory.eINSTANCE.createProcMap()));

		newChildDescriptors.add
			(createChildParameter
				(DataPackage.Literals.MAPPING__TASK_MAP_LIST,
				 DataFactory.eINSTANCE.createTaskMap()));

		newChildDescriptors.add
			(createChildParameter
				(DataPackage.Literals.MAPPING__VAR_MAP_LIST,
