 ...
 * </copyright>
 *
 * $Id: ResourceItemProvider.java,v 1.1 2005/09/28 15:22:29 durin Exp $
 */
...
/**
 * This is the item provider adpater for a {@link rtdruid.vartree.data.Resource} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ResourceItemProvider
		...
		itemPropertyDescriptors.add
			(new ItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 DataPackage.eINSTANCE.getResource_Name(),
				 true,
	...
	protected void addMethodsPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(new ItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Resource_Methods_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Resource_Methods_feature", "_UI_Resource_type"),
				 DataPackage.eINSTANCE.getResource_Methods(),
				 true,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE));
	}
	...
	public Collection getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(DataPackage.eINSTANCE.getResource_MutexRefList());
		}
	...
	public String getText(Object object) {
		StringVar labelValue = ((Resource)object).getName();
	...
	protected void collectNewChildDescriptors(Collection newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(DataPackage.eINSTANCE.getResource_MutexRefList(),
				 DataFactory.eINSTANCE.createMutexRef()));
	}
