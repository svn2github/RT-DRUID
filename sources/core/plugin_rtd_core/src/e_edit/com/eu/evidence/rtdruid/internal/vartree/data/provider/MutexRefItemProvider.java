...
/**
 * This is the item provider adapter for a {@link com.eu.evidence.rtdruid.vartree.data.MutexRef} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class MutexRefItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 DataPackage.Literals.MUTEX_REF__MODE_REF,
				 true,
				 false,
				 false,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 DataPackage.Literals.MUTEX_REF__MUTEX_NAME,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/MutexRef"));
	}
	...
	public String getText(Object object) {
		StringVar labelValue = ((MutexRef)object).getMutexName();
		String label = labelValue == null ? null : labelValue.toString();
		return label == null || label.length() == 0 ?
			getString("_UI_MutexRef_type") :
			getString("_UI_MutexRef_type") + " " + label;
	}
