 ...
 * </copyright>
 *
 * $Id: BusItemProvider.java,v 1.1 2005/09/28 15:22:29 durin Exp $
 */
...
/**
 * This is the item provider adpater for a {@link rtdruid.vartree.data.Bus} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class BusItemProvider
		...
		itemPropertyDescriptors.add
			(new ItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Bus_Name_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Bus_Name_feature", "_UI_Bus_type"),
				 DataPackage.eINSTANCE.getBus_Name(),
				 true,
		...
		itemPropertyDescriptors.add
			(new ItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 DataPackage.eINSTANCE.getBus_Type(),
				 true,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE));
	}
	...
	protected void addSpeedPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(new ItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Bus_Speed_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Bus_Speed_feature", "_UI_Bus_type"),
				 DataPackage.eINSTANCE.getBus_Speed(),
				 true,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE));
	}
	...
	public Object getImage(Object object) {
		return getResourceLocator().getImage("full/obj16/Bus");
	}
	...
	public String getText(Object object) {
		StringVar labelValue = ((Bus)object).getName();
