 ...
 * </copyright>
 *
 * $Id: SignalItemProvider.java,v 1.1 2005/09/28 15:22:29 durin Exp $
 */
...
/**
 * This is the item provider adpater for a {@link rtdruid.vartree.data.Signal} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class SignalItemProvider
		...
		itemPropertyDescriptors.add
			(new ItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 DataPackage.eINSTANCE.getSignal_Name(),
				 true,
		...
		itemPropertyDescriptors.add
			(new ItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 DataPackage.eINSTANCE.getSignal_Type(),
				 true,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE));
	}
	...
	protected void addOilVarPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(new ItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Signal_OilVar_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Signal_OilVar_feature", "_UI_Signal_type"),
				 DataPackage.eINSTANCE.getSignal_OilVar(),
				 true,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE));
	}
	...
	public Object getImage(Object object) {
		return getResourceLocator().getImage("full/obj16/Signal");
	}
	...
	public String getText(Object object) {
		StringVar labelValue = ((Signal)object).getName();
