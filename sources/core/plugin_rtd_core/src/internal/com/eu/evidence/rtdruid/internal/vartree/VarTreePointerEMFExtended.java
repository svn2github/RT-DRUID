...
class VarTreePointerEMFExtended extends VarTreePointerEMF {
	// JAVADOC : aggiungere tutti i commenti !!
	...
	public VarTreePointerEMFExtended(EList root, EditingDomain editingDomain) {
	 ...
	 *
	 */
	protected LittlePointer makeSteps(Stack path, LittlePointer current) {
		boolean answer = true;
