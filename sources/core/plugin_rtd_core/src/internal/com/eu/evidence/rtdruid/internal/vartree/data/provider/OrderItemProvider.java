 ...
 * </copyright>
 *
 * $Id: OrderItemProvider.java,v 1.1 2005/09/28 15:22:29 durin Exp $
 */
...
/**
 * This is the item provider adpater for a {@link rtdruid.vartree.data.Order} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class OrderItemProvider
		...
		itemPropertyDescriptors.add
			(new ItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Order_FirstEvent_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Order_FirstEvent_feature", "_UI_Order_type"),
				 DataPackage.eINSTANCE.getOrder_FirstEvent(),
				 true,
	...
	protected void addSecondEventPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(new ItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Order_SecondEvent_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Order_SecondEvent_feature", "_UI_Order_type"),
				 DataPackage.eINSTANCE.getOrder_SecondEvent(),
				 true,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE));
	}
	...
	public Object getImage(Object object) {
		return getResourceLocator().getImage("full/obj16/Order");
	}
	...
	public String getText(Object object) {
		String firstValue = varToString(((Order)object).getFirstEvent());
		String secondValue = varToString(((Order)object).getSecondEvent());
