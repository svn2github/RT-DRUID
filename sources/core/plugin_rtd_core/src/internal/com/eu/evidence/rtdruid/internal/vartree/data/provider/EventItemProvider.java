 ...
 * </copyright>
 *
 * $Id: EventItemProvider.java,v 1.1 2005/09/28 15:22:29 durin Exp $
 */
...
/**
 * This is the item provider adpater for a {@link rtdruid.vartree.data.Event} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class EventItemProvider
		...
		itemPropertyDescriptors.add
			(new ItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 DataPackage.eINSTANCE.getEvent_Name(),
				 true,
		...
		itemPropertyDescriptors.add
			(new ItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 DataPackage.eINSTANCE.getEvent_Type(),
				 true,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE));
	}
	...
	protected void addMethodRefNamePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(new ItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Event_MethodRefName_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Event_MethodRefName_feature", "_UI_Event_type"),
				 DataPackage.eINSTANCE.getEvent_MethodRefName(),
				 true,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE));
	}
	...
	public Object getImage(Object object) {
		return getResourceLocator().getImage("full/obj16/Event");
	}
	...
	public String getText(Object object) {
		StringVar labelValue = ((Event)object).getName();
