 ...
 * </copyright>
 *
 * $Id: VarItemProvider.java,v 1.1 2005/09/28 15:22:29 durin Exp $
 */
...
/**
 * This is the item provider adpater for a {@link rtdruid.vartree.data.Var} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class VarItemProvider
		...
		itemPropertyDescriptors.add
			(new ItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 DataPackage.eINSTANCE.getVar_Type(),
				 true,
	...
	protected void addMethodsPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(new ItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Var_Methods_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Var_Methods_feature", "_UI_Var_type"),
				 DataPackage.eINSTANCE.getVar_Methods(),
				 true,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE));
	}
	...
	public Object getImage(Object object) {
		return getResourceLocator().getImage("full/obj16/Var");
	}
	...
	public String getText(Object object) {
		StringVar labelValue = ((Var)object).getName();
