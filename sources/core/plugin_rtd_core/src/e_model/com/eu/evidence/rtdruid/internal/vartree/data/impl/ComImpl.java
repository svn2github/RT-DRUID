 ...
 * <ul>
 *   <li>{@link com.eu.evidence.rtdruid.internal.vartree.data.impl.ComImpl#getName <em>Name</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class ComImpl extends ObjectWithIDImpl implements Com {
	/**
	...
	protected EClass eStaticClass() {
		return DataPackage.Literals.COM;
	}
	...
	public void setName(StringVar newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DataPackage.COM__NAME, oldName, name));
	}
