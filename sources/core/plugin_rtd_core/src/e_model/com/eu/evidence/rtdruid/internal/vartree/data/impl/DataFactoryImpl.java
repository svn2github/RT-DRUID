...
{
	protected HashMap extendedVariables;
  ...
  public Object createExtendedVarFromString(EDataType eDataType, String initialValue) {
  	if (extendedVariables!= null && extendedVariables.containsKey("" + eDataType.getClassifierID())) {
  		return ((ExtendVar) extendedVariables.get("" + eDataType.getClassifierID())).createFromString(initialValue);
  	}
   ...
   * <!-- end-user-doc -->
	 * @generated
	 */
  protected Object createFromStringGen(EDataType eDataType, String initialValue) {
		switch (eDataType.getClassifierID()) {
			...
			case DataPackage.FAST_TASK_TO_PROC_MAP_VAR:
				return "";
			default:
  ...
  public String convertToString(EDataType eDataType, Object instanceValue) {
  	if (extendedVariables!= null && extendedVariables.containsKey("" + eDataType.getClassifierID())) {
  		return ((ExtendVar) extendedVariables.get("" + eDataType.getClassifierID())).convertToString(instanceValue);
  	}
  ...
  {
	return new OilVar(initialValue);
  }
  ...
  {
	return new TimeVar(initialValue);
  }
  ...
  public String convertTimeVarToString(EDataType eDataType, Object instanceValue) {
	...
	public PropertyVar createPropertyVarFromString(EDataType eDataType, String initialValue) {
		return new PropertyVar(initialValue);
	}
  ...
  public void extendVariable(EDataType eDataType, Class instanceClass, ExtendVar helper) {
