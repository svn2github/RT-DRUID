 ...
 *   <li>{@link com.eu.evidence.rtdruid.vartree.data.Cpu#getOsApplication <em>OsApplication</em>}</li>
...
public interface Cpu extends ObjectWithID{
  ...
  /**
  	 ...
  	 * The list contents are of type {@link rtdruid.vartree.data.OsApplication}.
  	 * <!-- begin-user-doc -->
  	 * <p>
  	 ...
  	 * @see rtdruid.vartree.data.DataPackage#getCpu_OsApplication()
  	 * @model type="rtdruid.vartree.data.OsApplication" containment="true"
  	 * @generated
  	 */
  	EList getOsApplication();
