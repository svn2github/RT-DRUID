 ...
 *
 * $Id: SchedWithoutOffset.java,v 1.1 2007/05/10 07:55:48 durin Exp $
 */
...
/**
 * An ANT TASK to perform Schedulability analysis without offset
 * 
		...
		try {
			...
			for (int i = 0; i < system.length; i++) {
				try {
	    			...
	    			String report = JScan.startTest(vt, system[i], JScan.NO_OFFSET_ID, options);
	    			log(report);
