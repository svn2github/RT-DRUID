 ...
 */
public class Mico32BoardXP2Camera extends AMico32Board {
...
//				GROUP_ETHERNET);
	...
	public Mico32BoardXP2Camera(IVarTree vt) {
		this.vt = vt;
	}
	...
	public void updateObjects(final IOilObjectList[] oilObjects, ArrayList<String> eeoptions) throws OilCodeWriterException {
		...
		if (foundOptions.contains(ALL_ZIGBEE)) {
			if (all != 0) {
				throw new OilCodeWriterException ("Mico32, xp2 camera board: it is illegal to require both ETHERNET and ZIGBEE options");
			}
			all = GROUP_ZIGBEE;
		}
