...
//							configTemplateError = "Select a template";
	...
	public RTDOilProjectWizard() {
		...
		if (cdt_ver != RTDOilProjectNature.CDT_VERS_34 && cdt_ver != RTDOilProjectNature.CDT_VERS_LESS_THAN_34) {
...
//			MessageBox mb = new MessageBox(getShell(), SWT.ICON_ERROR);
	...
	protected void doRun(IProgressMonitor monitor) throws CoreException {
		...
		if (newProject != null) {
			 ...
			 */
		    RTDOilProjectNature.addNature(newProject, monitor);
			 ...
			 * resource
			 */
		    // RTDOilProjectNature.setCDTWorkFolder(newProject, "${project_name}\\Debug");
		    RTDOilProjectNature.setCDTWorkFolder(newProject, "/" + newProject.getName() + "/Debug");
		    RTDOilProjectNature.setCDTBuildCommand(newProject, null);
		     ...
		     */
		    IPath path = new Path(newProject.getName()+IPath.SEPARATOR+niosWizardPage.configFile);
		     ...
		     * add the config file
		     */
		    IFile configFile = newProject.getFile(niosWizardPage.configFile);
		    ...
		    if (template!= null) {
		    	...
		    	try {
		    		copyManager.copyIntoAProject(newProject, monitor);
		    	} catch(Exception e) {
