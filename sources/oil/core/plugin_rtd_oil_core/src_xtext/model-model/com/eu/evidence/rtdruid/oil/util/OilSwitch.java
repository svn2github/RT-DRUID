...
public class OilSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case OilPackage.OIL_OBJECT: {
				OilObject oilObject = (OilObject)theEObject;
				T result = caseOilObject(oilObject);
				if (result == null) result = caseParameterRef(oilObject);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case OilPackage.PARAMETER: {
				Parameter parameter = (Parameter)theEObject;
				T result = caseParameter(parameter);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case OilPackage.OIL_APPLICATION: {
				OilApplication oilApplication = (OilApplication)theEObject;
				T result = caseOilApplication(oilApplication);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case OilPackage.OIL_IMPLEMENTATION: {
				OilImplementation oilImplementation = (OilImplementation)theEObject;
				T result = caseOilImplementation(oilImplementation);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case OilPackage.OIL_OBJECT_IMPL: {
				OilObjectImpl oilObjectImpl = (OilObjectImpl)theEObject;
				T result = caseOilObjectImpl(oilObjectImpl);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case OilPackage.PARAMETER_TYPE: {
				ParameterType parameterType = (ParameterType)theEObject;
				T result = caseParameterType(parameterType);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case OilPackage.VALUE_TYPE: {
				ValueType valueType = (ValueType)theEObject;
				T result = caseValueType(valueType);
				if (result == null) result = caseParameterType(valueType);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case OilPackage.ENUMERATOR_TYPE: {
				EnumeratorType enumeratorType = (EnumeratorType)theEObject;
				T result = caseEnumeratorType(enumeratorType);
				if (result == null) result = caseParameterRef(enumeratorType);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case OilPackage.VARIANT_TYPE: {
				VariantType variantType = (VariantType)theEObject;
				T result = caseVariantType(variantType);
				if (result == null) result = caseParameterType(variantType);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			...
			case OilPackage.REFERENCE_TYPE: {
				ReferenceType referenceType = (ReferenceType)theEObject;
				T result = caseReferenceType(referenceType);
				if (result == null) result = caseParameterType(referenceType);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case OilPackage.PARAMETER_REF: {
	 ...
	 * @generated
	 */
	public T caseOilObject(OilObject object) {
		return null;
	}
	 ...
	 * @generated
	 */
	public T caseOilApplication(OilApplication object) {
		return null;
	}
	 ...
	 * @generated
	 */
	public T caseOilImplementation(OilImplementation object) {
		return null;
	}

	/**
	 * Returns the result of interpreting the object as an instance of '<em>Object Impl</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Object Impl</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseOilObjectImpl(OilObjectImpl object) {
		return null;
	}
