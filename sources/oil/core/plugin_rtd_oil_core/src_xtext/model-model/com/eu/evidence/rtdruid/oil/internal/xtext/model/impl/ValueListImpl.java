 ...
 * <ul>
 *   <li>{@link com.eu.evidence.rtdruid.oil.internal.xtext.model.impl.ValueListImpl#getValues <em>Values</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ValueListImpl extends EObjectImpl implements ValueList {
	...
	protected EClass eStaticClass() {
		return OilPackage.Literals.VALUE_LIST;
	}
	...
	public EList<String> getValues() {
		if (values == null) {
			values = new EDataTypeUniqueEList<String>(String.class, this, OilPackage.VALUE_LIST__VALUES);
		}
		return values;
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case OilPackage.VALUE_LIST__VALUES:
				return getValues();
		}
