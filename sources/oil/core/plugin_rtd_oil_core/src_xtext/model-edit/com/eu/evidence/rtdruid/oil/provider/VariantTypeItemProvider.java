...
/**
 * This is the item provider adapter for a {@link com.eu.evidence.rtdruid.oil.xtext.model.VariantType} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class VariantTypeItemProvider
	extends ParameterTypeItemProvider
	implements
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(OilPackage.Literals.VARIANT_TYPE__VALUES);
		}
	...
	public String getText(Object object) {
		String label = ((VariantType)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_VariantType_type") :
			getString("_UI_VariantType_type") + " " + label;
	}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(OilPackage.Literals.VARIANT_TYPE__VALUES,
				 OilFactory.eINSTANCE.createEnumeratorType()));
	}
