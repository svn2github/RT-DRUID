...
/**
 * This is the item provider adapter for a {@link com.eu.evidence.rtdruid.oil.xtext.model.Parameter} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ParameterItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 OilPackage.Literals.PARAMETER__TYPE,
				 true,
				 false,
				 true,
				 null,
	...
	protected void addValueRefPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Parameter_ValueRef_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Parameter_ValueRef_feature", "_UI_Parameter_type"),
				 OilPackage.Literals.PARAMETER__VALUE_REF,
				 true,
				 false,
				 true,
				 null,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(OilPackage.Literals.PARAMETER__PARAMETERS);
		}
	...
	public String getText(Object object) {
		String label = ((Parameter)object).getDescription();
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(OilPackage.Literals.PARAMETER__PARAMETERS,
