...
public class CommentWriterCpp implements ICommentWriter {
	/**
	 * Should be used to identify files managed by this writer
	 */
	public static final String WRITER_ID = FileTypes.CPP;

	/**
	 * This method prepares a banner as a Comment in the Cpp Style. Accepts null
	 * messages.
	 * 
	 * @param message
