...
public class CommentWriterC implements ICommentWriter {
	
	/**
	 * Should be used to identify files managed by this writer
	 */
	public static final String WRITER_ID = FileTypes.C;

	
	/**
	 * This method prepares a banner as a Comment in the C Style. Accepts null
	 * messages.
	 * 
	 * @param message
	...
	/**
	 * This method prepares a Comment in the C Style. Accepts null
	...
	/**
	 * This method prepares a Multiline Comment in the C Style. Accepts null
	 * messages.
	 * 
	 * The result always ends with a new line.
	 * 
	...
	public String writerMultiLineComment(String indent, String message) {
		...
		StringBuffer answer = new StringBuffer(indent + "/*\n");
